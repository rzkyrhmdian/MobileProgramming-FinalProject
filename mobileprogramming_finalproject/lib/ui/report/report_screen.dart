                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        if (viewModel.currentLatitude != null &&
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: FlutterMap(
                                ...
                                key: ValueKey(
                                  '${viewModel.currentLatitude}_${viewModel.currentLongitude}',
                                ),
                                options: MapOptions(
                                ...
                                InkWell(
                                  onTap: () {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          "Memperbarui lokasi ke titik saat ini...",
                                        ),
                                        duration: Duration(seconds: 2),
                                      ),
                                    );
                                    viewModel
                                        .getCurrentLocation(); // Panggil ulang GPS
                                  },
                                ...
                                onTap: () async {
                                  ...
                                  if (success) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          "Gagal menyimpan. Pastikan form lengkap & GPS aktif.",
                                        ),
