                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EditDetailGarageScreen(
    ...
    showDialog(
      ...
      builder: (dialogContext) => Theme(
        ...
        child: AlertDialog(
          ...
          content: const Text(
            'Data kendaraan ini akan dihapus secara permanen dari garasi SiPatuh Anda.',
          ),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(context); // Kembali ke list Garasi
              },
              style: ElevatedButton.styleFrom(
