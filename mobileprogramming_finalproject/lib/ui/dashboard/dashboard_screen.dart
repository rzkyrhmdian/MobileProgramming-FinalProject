...
class _DashboardScreenState extends State<DashboardScreen> {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'Wujudkan ketertiban berlalu lintas dengan partisipasi aktif Anda. Setiap laporan membantu menciptakan jalan raya yang lebih aman bagi semua masyarakat.',
                              style: TextStyle(
                                fontSize: 12,
  ...
  Widget _buildLatestReportTile(ReportInfo report) {
    ...
    String displayAddress = report.alamat.isNotEmpty
        ? report.alamat.split(',').first
